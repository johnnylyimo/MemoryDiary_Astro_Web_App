...
export const CreateDisplayMemory = () => {
    ...
    return (
        <main className="w-full h-auto flex flex-col lg:flex-row gap-8 text-center p-4">
            ...
            {/* Edit Popup */}
            {
            editMemoryPopUp ? <div className="absolute top-[35%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#E1BEE7] w-[90%] md:w-[45%] flex justify-center items-center flex-col"></div> : null
            }
            </section>
